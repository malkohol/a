 ...
 */
    ...
    $fbconfig['baseurl']    = "http://apps.facebook.com/cmhdata/index.php";

define("FACEBOOK_APP_ID", '623553027679375');
define("FACEBOOK_API_KEY", '');
define("FACEBOOK_SECRET_KEY", 'a7c42e57cc0d45a472eede008f936e13');
define("FACEBOOK_CANVAS_URL", 'https://www.facebook.com/pages/CMH-data-Community/150865338455384?id=150865338455384&sk=app_623553027679375');


define("FACEBOOK_PAGE_URL", 'https://www.facebook.com/pages/CMH-data-Community/150865338455384?id=150865338455384&sk=app_623553027679375');
define("AUTH_URL", FACEBOOK_CANVAS_URL.'auth.php');

define("DB_HOST", 'sql');
define("DB_NAME", 'dentakuteszt1');
        ...
        if (isset($_GET['publish'])){
            try {
                $publishStream = $facebook->api("/$user/feed", 'post', array(
                    'message' => "Praktiker Sufni", 
                    'link'    => 'https://www.facebook.com/GeneratorCommunity/app_474812722549686',
                    'picture' => 'http://teszt4.dentaku.hu/teszt/img/store/avatar_female1.png',
                    'name'    => 'Praktiker',
                    'description'=> 'aaa'
                    )
                );
